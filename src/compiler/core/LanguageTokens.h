...
inline constexpr std::array<std::string_view, 25> AllKeywords = {
	KwAlias, KwAnd, TypeBool, KwDef, KwElse, KwEnum, KwFalse, KwImport, KwIn, TypeInt, KwNot, KwOr, TypeReal, KwRep, KwReturn, KwRun, TypeString, KwStruct, KwTrue, TypeUint, KwUnion, KwVal, KwVar, TypeVoid, KwWhen};
} // namespace LanguageTokens